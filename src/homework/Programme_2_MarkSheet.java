...
public class Programme_2_MarkSheet {
    public static void main(String[] args) {
        ...
        while(mathsMarks < 0|| mathsMarks>100) {
            ...
            System.out.println("Plese enter correct marks of maths");
    ...
    // calculating the sum
            ...
            // calculating th result of subject marks
    ...
    public static void printTheMarkSheet( String name, int rollNum, int mathsMarks, int scienceMarks, int englishMarks, double total, double percentage,
